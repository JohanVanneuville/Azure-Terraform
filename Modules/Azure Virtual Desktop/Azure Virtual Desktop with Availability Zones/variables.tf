...
variable "subnet_id" {
  ...
  default = "/subscriptions/your subscription id/resourceGroups/rg-prd-jvn-avd-networking-01/providers/Microsoft.Network/virtualNetworks/vnet-prd-jvn-avd-we-01/subnets/snet-prd-jvn-avd-session-hosts-01"
...
variable "domain" {
  description = "corp.johanvanneuville.com" 
  default = ""
}
